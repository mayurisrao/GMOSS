...
#x_ini = np.array([-5.761185054330454e-08, 2.6728667075093107, 2.7477254162083455, 247386337.5370596/1e9, 1e-10, 8000.0, 0.001]) # works
...
def func(pp: np.ndarray) -> float: #pp is an array
    ...
    #blowing up the  
    if alpha1 < 2.0 or alpha1 > 2.0: alpha1 = 1000000000
