...
class ConvexModel:
    ...
    def func(
        self, parameters
    ) -> float:  # pp is the variable in c code here it is parameters and it is an array
...
if __name__ == "__main__":
    ...
    path_to_initial_parameters_file = DATA + "convex_model_initial_parameters.csv"
